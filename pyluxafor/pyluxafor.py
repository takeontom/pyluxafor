...
class LuxaforFlag(object):
    ...
    def write(self, values):
        ...
        Expects the values to be an iterable of command byte codes. Refer to
    ...
    def create_fade_colour_command(self, led, r, g, b, duration):
        return [LuxaforFlag.MODE_FADE_COLOUR, led, r, g, b, duration]

    def create_strobe_command(self, led, r, g, b, duration, repeat):
        return [LuxaforFlag.MODE_STROBE, led, r, g, b, duration, 0, repeat]

    def create_wave_command(self, wave_type, r, g, b, duration, repeat):
        return [
            LuxaforFlag.MODE_WAVE, wave_type, r, g, b, duration, 0, repeat
        ]

    def create_pattern_command(self, pattern_id, repeat):
